---
title: "50 Prompt ChatGPT untuk Sales: Prospecting, Follow-Up, Closing, CRM, dan Proposal"
description: "50 prompt ChatGPT untuk sales yang terstruktur untuk ICP, prospecting, discovery, follow-up, objection handling, closing, proposal, WhatsApp, CRM, pipeline, dan coaching."
pubDate: "2026-06-20"
updatedDate: "2026-08-02"
author: "AI Praktis Indonesia"
category: "prompt-engineering"
tags:
  - Prompt ChatGPT untuk Sales
...
1. gunakan sumber kebenaran yang disetujui;
2. minimalkan data pribadi;
3. jangan memasukkan password, token, atau data rahasia;
4. tandai asumsi;
5. periksa harga, fitur, syarat, dan tanggal;
6. hormati penolakan dan kriteria berhenti;
7. gunakan manusia untuk keputusan yang berdampak.
...
1. Prompt 14 merangkum discovery.
2. Prompt 15 memeriksa qualification.
3. Prompt 17 menyusun demo.
4. Prompt 22 membuat follow-up.
5. Prompt 41 membuat CRM note.
6. Prompt 50 mengaudit hasil.
...
- [OpenAI — Privasi tingkat Enterprise](https://openai.com/id-ID/enterprise-privacy/)
- [OpenAI — Privasi, keamanan, dan kepatuhan data bisnis](https://openai.com/id-ID/business-data/)
