...
```text
Ide → Script → Storyboard → Voice-over → Editing → Caption → Publish
```
...
```text
catatan acak → ringkasan → action items → laporan
```
...
```text
Meeting → Transkrip → Notulen → Action Items → Follow-up Email
```
