...
|---|---|---|---|
| Narrow AI | Sudah ada | Tugas spesifik | ChatGPT, Google Translate, rekomendasi YouTube |
| General AI | Masih konsep/riset | Kemampuan umum seperti manusia | Belum ada contoh nyata |
| Super AI | Masih teori | Melampaui manusia | Belum ada contoh nyata |
...
|---|---|---|
| Reactive Machine | Ada | Merespons input saat ini |
| Limited Memory | Ada | Memakai data/konteks terbatas |
| Theory of Mind | Teoretis/riset | Memahami pikiran dan emosi manusia |
| Self-Aware AI | Teoretis/fiksi | Memiliki kesadaran diri |
...
| Aspek | AI Chatbot | AI Agent |
|---|---|---|
| Fungsi utama | Menjawab dan berdialog | Menjalankan tugas |
| Alur kerja | Biasanya satu respons per prompt | Bisa multi-step |
| Tools | Tidak selalu memakai tools | Sering memakai tools |
| Kemandirian | Lebih rendah | Lebih tinggi |
| Pengawasan | Tetap perlu | Sangat perlu |
