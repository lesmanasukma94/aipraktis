...
|---|---|---|
| A | Tanggal Order | Tanggal transaksi |
| B | Nama Pelanggan | Nama pembeli |
| C | Produk | Nama produk |
| D | Jumlah | Jumlah item |
| E | Harga Satuan | Harga per item |
| F | Total | Jumlah x harga |
| G | Status Pembayaran | Lunas / Belum Lunas |
| H | Status Pengiriman | Diproses / Dikirim / Selesai |
