...
| Tahap | Tujuan | Konten |
|---|---|---|
| Awareness | Orang mengenal masalah | Reels edukasi, artikel dasar |
| Interest | Orang tertarik solusi | Carousel, webinar, checklist |
| Consideration | Orang membandingkan | Testimoni, FAQ, studi kasus |
| Conversion | Orang membeli/daftar | Landing page, promo, follow-up |
| Retention | Orang tetap aktif | Email tips, komunitas, bonus |
| Advocacy | Orang merekomendasikan | Referral, shareable content |
