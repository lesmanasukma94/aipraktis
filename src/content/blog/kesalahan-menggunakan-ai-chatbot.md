...
1. Minta AI memahami masalah.
2. Minta AI membuat outline.
3. Minta AI membuat draft.
4. Minta AI mengkritik draft.
5. Minta AI memperbaiki.
6. Minta AI membuat versi final.
...
1. AI untuk ide.
2. AI untuk draft.
3. Manusia untuk validasi dan eksekusi.
...
Salah satu penyebab hasil AI buruk adalah prompt yang tidak terstruktur. Pelajari [Struktur Prompt AI yang Baik](/blog/struktur-prompt-ai-yang-baik/) agar instruksi kepada AI lebih lengkap dan minim revisi.
