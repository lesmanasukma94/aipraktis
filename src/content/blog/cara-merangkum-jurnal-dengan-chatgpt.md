...
Bagian “jangan menambahkan informasi di luar teks” penting.
...
→ tempel abstrak ke ChatGPT
→ minta ringkasan awal
→ baca pendahuluan
→ minta ringkasan pendahuluan
→ baca metode
→ minta penjelasan metode
→ baca hasil dan pembahasan
→ minta ringkasan hasil
→ buat pertanyaan kritis
→ cek ulang jurnal asli
