...
| Intent | Arti | Contoh |
|---|---|---|
| Informasional | Ingin belajar | apa itu AI untuk SEO |
| Tutorial | Ingin langkah praktis | cara menggunakan AI untuk SEO |
| Komersial | Ingin membandingkan | AI tools SEO terbaik |
| Navigasional | Mencari brand/tools tertentu | Google Search Console |
| Transaksional | Siap membeli/daftar | beli tools SEO AI |
